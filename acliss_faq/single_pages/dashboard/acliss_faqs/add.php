...
if ($confirmDelete) {
     ...
     <form method="post" enctype="multipart/form-data" id="cm-delete-acliss-faq-form" action="<?php echo $this->url('/dashboard/acliss_faqs/add', 'delete', $aclissFaq->getAclissFaqID()) ?>">
          ...
          <div class="ccm-pane-footer">
               <div class="ccm-buttons">
                    ...
                    <input type="hidden" name="ID" value="<?php echo $aclissFaq->getAclissFaqID(); ?>" />
                    <?php print $ih->button(t('Cancel'), $this->url('/dashboard/acliss_faqs/search'), 'left', 'error') ?>
     ...
     <?php } else {
          ...
          <?php } ?>
          <form method="post" enctype="multipart/form-data" id="cm-acliss-faq-form" action="<?php echo $this->url('/dashboard/acliss_faqs/add') ?>">
               <div class="ccm-pane-body">			
                    <?php
